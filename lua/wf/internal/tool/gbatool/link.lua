...
SECTIONS {
    ...
    if config.memory ~= nil then
        ...
        if config.memory.overlay ~= nil and config.memory.overlay.ewram ~= nil and parent_name ~= "link-multiboot" then
...
local function romlink_run(args, linker_args)
    ...
    local parent_filename = "link-" .. args.subtarget
