...
SECTIONS {
    ...
    if config.overlays ~= nil and config.overlays.iwram ~= nil then
        rom_write_linkscript_overlay(f, "iwram", "IWRAM", config.overlays.iwram)
    end
    if config.overlays ~= nil and config.overlays.ewram ~= nil then
        rom_write_linkscript_overlay(f, "ewram", "EWRAM", config.overlays.ewram)
    end
