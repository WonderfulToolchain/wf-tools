...
target.address_ranges_to_banks = function(ranges, args, config)
    ...
    table.insert(banks, {name="EWRAM", range={0x02000000, 0x0203ffff}, size=262144, mask=0x3ffff, color=wfterm.fg.bright_purple()})
    if ranges[3] ~= nil then
        table.insert(banks, {name="VRAM", range={0x06000000, 0x06017fff}, size=96*1024, mask=0x1ffff, color=wfterm.fg.bright_blue()})
    end
